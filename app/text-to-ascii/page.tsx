...
export default function TextToAsciiPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-valo-dark text-valo-gray">
            <Head>
                <title>Text to ASCII Generator | Valorant ASCII Art</title>
                <meta name="description" content="Convert your name or text into stunning ASCII art suitable for Valorant chat. Choose from multiple fonts and styles to stand out in-game." />
            </Head>
