...
export default function GalleryPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-valo-dark text-valo-gray">
            <Head>
                <title>Valorant ASCII Art Gallery | Copy & Paste Copy/Pastas</title>
                <meta name="description" content="Browse our extensive gallery of pre-made Valorant ASCII art. One-click copy for crosshairs, abilities, rank icons, and classic GGWP messages for in-game chat." />
            </Head>
